...
export const advantages = [
  {
    ...
    description: 'Terdaftar sebagai "Power Improvement Device" (Paten No. 6274523, Jan 2018). Telah diimplementasikan di lebih dari 2.300 lokasi, terutama pabrik-pabrik besar.',
    icon: 'lucide:award',
  },
  {
    id: 2,
    title: 'Hemat 5–15% Listrik',
    description: 'Rata-rata penghematan 7% dari total konsumsi listrik. Investasi dapat kembali dalam 3–5 tahun tergantung kondisi fasilitas.',
    icon: 'lucide:trending-down',
  },
  {
    id: 3,
    title: 'Instalasi ±1 Jam',
    description: 'Proses instalasi hanya sekitar 1 jam dan mudah dipindahkan. Tidak memerlukan penghentian operasional fasilitas saat pemasangan.',
    icon: 'lucide:clock',
  },
  {
    id: 4,
    title: 'Tanpa Risiko Kerusakan',
    description: 'Tidak ada komponen elektronik (kapasitor, IC chip) yang bisa rusak atau menurun. Design life 15 tahun dengan garansi resmi 7 tahun.',
    icon: 'lucide:shield-check',
  },
  {
    id: 5,
    title: 'Kompatibel Semua Beban',
    description: 'Efektif untuk berbagai jenis beban: mesin press, pompa, injection molding, AC, compressor, rotary press, hingga cold storage.',
    icon: 'lucide:layout-grid',
  },
  {
    id: 6,
    title: 'Reduksi Emisi CO₂',
    description: 'Berkontribusi langsung pada pengurangan emisi CO₂ dan mendukung target carbon neutral 2050 sesuai komitmen iklim global.',
    icon: 'lucide:leaf',
  },
]
